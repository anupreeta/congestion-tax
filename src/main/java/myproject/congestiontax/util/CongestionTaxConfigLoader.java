...
import myproject.congestiontax.exception.TaxConfigNotFound;
...
public class CongestionTaxConfigLoader {
     ...
     */
    public CityTaxConfiguration getConfig(String name) {
        ...
        CityTaxConfiguration cityTaxConfiguration = new CityTaxConfiguration();
        try {
