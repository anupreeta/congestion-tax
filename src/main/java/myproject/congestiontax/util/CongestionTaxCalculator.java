...
import myproject.congestiontax.exception.InvalidVehicle;
import myproject.congestiontax.exception.NotSupportedTaxYear;
import myproject.congestiontax.exception.TaxConfigDataError;
...
public class CongestionTaxCalculator {
    ...
    private static final String BASE_PACKAGE = "myproject.congestiontax";
     ...
     * @return tax amount
     */
    public int getTax(Vehicle vehicle, Date[] dates, CityTaxConfiguration config)
    {
     ...
     */
    private boolean isTollFreeVehicle(Vehicle vehicle, CityTaxConfiguration config) {
     ...
     */
    public int getTollFee(Date date, Vehicle vehicle, CityTaxConfiguration config)
    {
     ...
     */
    private boolean isTollFreeDate(Date date, CityTaxConfiguration config)
    {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
